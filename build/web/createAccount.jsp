    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="MainController?action=Account_view">Account</a></li>
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" action="MainController" method="post">
                            <div class="col-md-12">
                               <input class="form-control" type="text" name="accountID" placeholder="AccountID" required>
                            </div>
                            ...
                            <div class="form-button mt-3">
                                <button style="margin-top: 10px; padding: 10px" id="submit" type="submit" class="btn btn-primary" name="action" value="Create_account">Create Account</button>
                            </div>
                        </form>
                    </div>
                </div>
