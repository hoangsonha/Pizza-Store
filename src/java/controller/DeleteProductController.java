...
public class DeleteProductController extends HttpServlet {
    ...
    private final static String ERROR = "ProductController";
        ...
        try {
            ...
            if (acc != null) {
                if (acc.getType() == 1) {
                    ...
                    if (check) {
                        String str = "D:\\NetBeans\\Asssiment\\web\\image\\" + productImg;
                        File file = new File(str);
                        Files.delete(file.toPath());
                        url = SUCCESS;
                        request.setAttribute("MESSAGE", "Delete product with id " + productID + " successfully!!!");
                    }
                } else {
                    url = LOGIN;
                } 
