  ...
  <main id="main" class="main">
    ...
    <section>
        <div class="text-center gd" style="font-size: 30px; margin-top: 30px">
            <a href="MainController?action=Create_Account_Page">Create Account</a>
        </div>
        <br>
        <br>
        ...
        <br>
        <br>
        <c:if test="${requestScope.ACCOUNT_LIST != null}">
            <c:if test="${not empty requestScope.ACCOUNT_LIST}">
                <table class="table table-bordered" style="margin-top: 20px; flex-grow: 1;" border="1">
                    ...
                    <tbody>
                    <c:forEach var="account" varStatus="counter" items="${requestScope.ACCOUNT_LIST}">
                        <form action="MainController">  
                            ...
                            <td>${account.type}</td>
                            <td>
                                <a class="separate" href="MainController?action=Update_Account_Page&accountID=${account.accountID}">Update</a>
                                <a href="MainController?action=Delete_account&accountID=${account.accountID}">Delete</a>
                            </td>
                        </tr>
                        </form>
                        </c:forEach>      
